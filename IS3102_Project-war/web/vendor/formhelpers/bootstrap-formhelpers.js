...
var BFHCurrenciesList = {
  ...
  'WST':{'label':'Samoan t�?l�?','currencyflag':'','symbol':'T'},
...
var BFHStatesList = {
  ...
  'MK':{
    ...
    '15' : {'code':'ČUČ','name':'Ču�?er-Sandevo'},
    '16' : {'code':'DEB','name':'Debar'},
    '17' : {'code':'DEB','name':'Debarca'},
    '18' : {'code':'DEL','name':'Del�?evo'},
    ...
    '25' : {'code':'GJO','name':'Gjor�?e Petrov'},
    ...
    '33' : {'code':'KIČ','name':'Ki�?evo'},
    '34' : {'code':'KIS','name':'Kisela Voda'},
    '35' : {'code':'KO�?','name':'Ko�?ani'},
    '36' : {'code':'KON','name':'Kon�?e'},
    ...
    '77' : {'code':'VEV','name':'Vev�?ani'},
    '78' : {'code':'VIN','name':'Vinica'},
    '79' : {'code':'VRA','name':'Vraneštica'},
    '80' : {'code':'VRA','name':'Vrap�?ište'},
